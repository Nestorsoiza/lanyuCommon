...
//    public static final DecimalFormat UN_DECIMAL = new DecimalFormat("0.#", DecimalFormatSymbols.getInstance(Locale.getDefault()));
//    public static final DecimalFormat DOS_DECIMALES = new DecimalFormat("0.#", DecimalFormatSymbols.getInstance(Locale.getDefault()));
